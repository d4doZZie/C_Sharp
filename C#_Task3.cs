...
namespace Guessing_Game
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nThere are 3 Levels. E- Easy, M- Medium, H- Hard");
            Console.Write("Which level of difficulty do you prefer: ");
            string userGuess = Console.ReadLine();

            if (userGuess == "E")
            {
                Console.WriteLine("\nYou have selected easy: You have to guess a number between 1 and 10");
                int i = 0;
                int a;
                while (i <= 5)
                {
